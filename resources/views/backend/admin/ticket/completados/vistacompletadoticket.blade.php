...
@section('title', 'Lista - Incidencias Por Revisar')

@section('content_header')
    <h1>Lista - Incidencias Por Revisar</h1>
    <p>Aqui el usuario de cada unidad ya finalizo el ticket, entonces aqui se completo la información</p>
@stop
...
@section('js')
    ...
    <script>
        ...
        function recargar() {
            var ruta = "{{ URL::to('/admin/ticket-incidencias-porrevisar/tabla') }}";
        ...
        function editar() {
            ...
            axios.post(urlAdmin + '/admin/ticket-incidencias/actualizar/porrevisar', formData)
                .then((response) => {
                    closeLoading();
                    if (response.data.success === 1) {
