        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item">Operador</li>
                    <li class="breadcrumb-item active">Listado de Operadores</li>
                </ol>
            </div>
        </div>
    </section>
...
@section('archivos-js')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var ruta = "{{ URL::to('/admin/operadores/tabla') }}";
    ...
    <script>
        ...
        function recargar(){
            var ruta = "{{ url('/admin/operadores/tabla') }}";
            $('#tablaDatatable').load(ruta);
        }
