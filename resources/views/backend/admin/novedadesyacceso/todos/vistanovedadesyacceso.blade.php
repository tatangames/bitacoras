...
@section('title', 'Lista - Novedades y Acceso')

@section('content_header')
    <h1>Lista - Novedades y Acceso</h1>
@stop
            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <button type="button" id="btn-guardar" class="btn btn-success btn-sm" onclick="editar()">Actualizar</button>
                    </div>
                </div>
            </div>
        </div>
...
@section('js')
    ...
    <script>
        $(function () {
            const ruta = "{{ url('/admin/bitacora/lista/novedadesacceso/tabla') }}";
    ...
    <script>
        ...
        function informacion(id){
            ...
            axios.post(urlAdmin+'/admin/bitacora/novedadesacceso/informacion',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
        ...
        function editar(){
            ...
            axios.post(urlAdmin + '/admin/bitacora/novedadesacceso/actualizar', formData)
                .then((response) => {
                    closeLoading();
                    if (response.data.success === 1) {
