...
@section('archivos-js')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var ruta = "{{ URL::to('/admin/bitacora/lista/mantenimiento/tabla') }}";
    ...
    <script>
        ...
        function informacion(id){
            ...
            axios.post(url+'/bitacora/mantenimiento/informacion',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
        ...
        function editar(){
            ...
            axios.post(url + '/bitacora/mantenimiento/actualizar', formData)
                .then((response) => {
                    closeLoading();
                    if (response.data.success === 1) {
