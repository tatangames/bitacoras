                        ...
                        <form id="form-nuevo">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label>Equipo</label>
                                    <input type="text" class="form-control" id="equipo-nuevo"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="observacion-nuevo"
...
@section('js')
    ...
    <script>
        ...
        function guardarRegistro(){
            ...
            axios.post(urlAdmin + '/admin/bitacora-mantenimiento/registro', formData)
                .then((response) => {
                    closeLoading();
